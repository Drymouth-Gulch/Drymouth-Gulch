...
/datum/uplink_item/stealthy_weapons/throwingweapons
	...
	desc = "A box of shurikens and tribal bolas. They are highly effective throwing weapons. The bolas can knock a target down and the shurikens will embed into limbs."
