...
/datum/design/super_capacitor
	...
	build_type = PROTOLATHE
	reliability = 71
	materials = list(MAT_METAL = 2000, MAT_GLASS = 2000, MAT_GOLD = 2000)
...
/datum/design/femto_mani
	...
	req_tech = list("materials" = 1)
	build_type = PROTOLATHE
	materials = list(MAT_METAL = 2000, MAT_DIAMOND = 1000)
	reliability = 73
...
/datum/design/quadultra_micro_laser
	...
	req_tech = list("materials" = 1)
	build_type = PROTOLATHE
	materials = list(MAT_METAL = 2000, MAT_GLASS = 2000, MAT_URANIUM = 2000, MAT_DIAMOND = 1000)
	reliability = 70
