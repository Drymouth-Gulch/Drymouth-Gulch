...
/obj/item/clothing/shoes/sneakers/brown
	...
	cmo
		item_color = "medical"	// Quality of life fixes for CMOs that don't want to get acided. Exists for washing machines. Is not different from brown shoes in any way.
		unacidable = 1
	cmo
