...
/obj/structure/bed/chair/e_chair/New()
	..()
	overlays += image('icons/obj/objects.dmi', src, "echair_overlay", MOB_LAYER + 1, dir)
	return
...
/obj/structure/bed/chair/e_chair/rotate()
	..()
	overlays.Cut()
	overlays += image('icons/obj/objects.dmi', src, "echair_overlay", MOB_LAYER + 1, dir)	//there's probably a better way of handling this, but eh. -Pete
	return
