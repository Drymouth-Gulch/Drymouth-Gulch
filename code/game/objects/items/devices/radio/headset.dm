...
/obj/item/device/radio/headset/headset_vlt
	...
	desc = "This is a Vault headset, not that you'd really need it since your assholes and elbows anyways. \nTo access the Vault channel, use :v."
	//icon_state = "sec_headset"
	item_state = "headset"
	keyslot = new /obj/item/device/encryptionkey/headset_vlt

/obj/item/device/radio/headset/headset_leg
	name = "Legion radio headset"
	desc = "This is a Legion headset, smoke signals and runners aren't enough anymore. \nTo access Legion channel, use :e."
	//icon_state = "sec_headset"
	item_state = "headset"
	keyslot = new /obj/item/device/encryptionkey/headset_leg

/obj/item/device/radio/headset/headset_ncr
	name = "NCR radio headset"
	desc = "This is a NCR headset, communication is important to any good military unit. \nTo access NCR channel, use :c."
	//icon_state = "sec_headset"
	item_state = "headset"
	keyslot = new /obj/item/device/encryptionkey/headset_ncr

/obj/item/device/radio/headset/headset_den
	name = "Den radio headset"
	desc = "This is a Den headset, always gotta make sure you can order your drinks from across the wasteland. \nTo access Den channel, use :d."
	//icon_state = "sec_headset"
	item_state = "headset"
	keyslot = new /obj/item/device/encryptionkey/headset_den

/obj/item/device/radio/headset/headset_enclave
	name = "Enclave radio headset"
	desc = "This is a Enclave headset, gotta make sure you can hear the sound of freedom from anywhere in the wasteland. \nTo access Den channel, use :q."
	//icon_state = "sec_headset"
	item_state = "headset"
