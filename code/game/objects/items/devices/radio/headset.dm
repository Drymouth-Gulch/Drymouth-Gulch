...
/obj/item/device/radio/headset/headset_vlt
	...
	desc = "A Vault headset, not that you need it considering your in spitting distance from everyone. \nTo access the Vault channel, use :v."
	//icon_state = "sec_headset"
	item_state = "headset"
...
/obj/item/device/radio/headset/headset_leg
	...
	desc = "A Legion headset, eventually smoke signals and runners weren't enough. \nTo access Legion channel, use :e."
	//icon_state = "sec_headset"
	item_state = "headset"
...
/obj/item/device/radio/headset/headset_ncr
	...
	desc = "A NCR headset, remember soldier, communication is important to a cohesive unit. \nTo access NCR channel, use :c."
	//icon_state = "sec_headset"
	item_state = "headset"
...
/obj/item/device/radio/headset/headset_den
	...
	desc = "A Den headset, for when you need to order your drink on the other side of the wasteland. \nTo access Den channel, use :d."
	//icon_state = "sec_headset"
	item_state = "headset"
...
/obj/item/device/radio/headset/headset_enclave
	...
	desc = "A Enclave headset, rebuilding america one communication at a time. \nTo access Den channel, use :q."
	//icon_state = "sec_headset"
	item_state = "headset"
...
/obj/item/device/radio/headset/headset_bos
	...
	//icon_state = "com_headset_alt"
	item_state = "headset"
	keyslot = new /obj/item/device/encryptionkey/headset_bos
///////////////////////////////
