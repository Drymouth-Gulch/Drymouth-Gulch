...
/proc/get_sfx(soundin)
	if(istext(soundin))
		switch(soundin)
			...
			if ("explosion") soundin = pick('sound/f13effects/explosion_1.ogg','sound/f13effects/explosion_2.ogg')
			if ("distexplosion") soundin = pick('sound/f13effects/explosion_distant_1.ogg','sound/f13effects/explosion_distant_2.ogg','sound/f13effects/explosion_distant_3.ogg','sound/f13effects/explosion_distant_4.ogg')
			...
			if ("10mmfire") soundin = pick('sound/f13weapons/10mm_fire_01.ogg', 'sound/f13weapons/10mm_fire_02.ogg','sound/f13weapons/10mm_fire_03.ogg')
			if ("ricochet") soundin = pick('sound/f13weapons/ric_1.ogg','sound/f13weapons/ric_2.ogg','sound/f13weapons/ric_3.ogg','sound/f13weapons/ric_4.ogg','sound/f13weapons/ric_5.ogg')
			...
			if ("krotchy") soundin = pick('sound/f13items/k_daddysaidonly.wav', 'sound/f13items/k_donttouchme.wav','sound/f13items/k_mommysaiddont.wav')
	return soundin
